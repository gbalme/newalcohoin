...
uint256 hashGenesisBlock("0xd0746a7266ca08b252238d5c96ec5ae48d5e01e9ce39d75cc732b7689794445b");
...
const string strMessageMagic = "Alcohoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight < 101)
    {
       nSubsidy = 3000 * COIN; // 1% Premine
    }
    else if(nHeight < 28801)
    {
       nSubsidy = 150* COIN;
    }
...
static const int64 nTargetTimespan = 5 * 60; // Alcohoin: retarget after 5 minutes
static const int64 nTargetSpacing = 60; // Alcohoin: 1 minute block
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Alcohoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Alcohoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7cf6b317d509ad6467c6e71e5506207008755409eb96015fab5f8f5be0440bef");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1390404700; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 19289;

        if (fTestNet)
        {
            block.nTime    = 1390401730;
            block.nNonce   = 1971236;
        }
